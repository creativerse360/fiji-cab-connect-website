        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 mb-20">
          ...
          <div>
            ...
            <p className="text-gray-300 text-2xl md:text-3xl max-w-2xl leading-relaxed">
              Fiji&apos;s first ride-hailing platform for tourists and locals across Fiji. Book by phone with professional, verified drivers and pay your driver in cash. App updates coming soon, subject to required approvals.
            </p>
          </div>
